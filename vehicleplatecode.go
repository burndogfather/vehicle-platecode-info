...
func crawling(ctx context.Context, plateCode string, res http.ResponseWriter){
	...
	err := chromedp.Run(ctx,
			emulation.SetUserAgentOverride(`Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36 `), //USER AGENT설정
